...
8. Added ADKRouter for flexible System1/System2 routing, robust connection backoff and graceful shutdown in orchestrator, plus comprehensive memory/resource cleanup and evolution executor.

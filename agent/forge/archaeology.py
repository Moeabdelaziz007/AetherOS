...
SHADOW_MAPS_FILE = Path("agent/memory/SHADOW_MAPS.json")
...
class APIArchaeologist:
    ...
    async def excavate(self, service_name: str) -> Optional[Dict]:
        """
    ...
    async def register_discovery(self, service_name: str, endpoint: str, confidence: float = 1.0):
        """
...
# Global singleton
archaeologist = APIArchaeologist()
